...
void CBall::SetPos(const CVector3& pos){
	mBall.mPosition = pos;
	mBall.Update();
	//C3DBoxCollider *p = new C3DBoxCollider();
	//CTask::mMatrix = mBox.mMatrix;
		//p->mSize = CVector3(1000, 20, 1000);
	//p->mpTask = this;
	//CCollisionManager::Get()->Add(p);
}
//void CBall::Init(){
...
//	glPopMatrix();
//}
//void CBall::SetDiffuse(float r, float g, float b, float a){
//	mBall.SetDiffuse(r, g, b, a);
//}
void CBall::OnCollision(C3DCollider *p){
