...
stage::stage(CModel *model, float px, float py, float pz, float rx, float ry, float rz, float sx, float sy, float sz) {
...
//void stage::OnCollision(CCollider *m, CCollider *y) {
